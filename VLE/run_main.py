...
dataset_list = ['SBU_3DFE','SJAFFE','Human_Gene','Movie','Natural_Scene',
'Yeast_alpha','Yeast_cdc','Yeast_cold','Yeast_diau','Yeast_dtt','Yeast_elu',
...
parser.add_argument('--src_path',type=str,default=p.join(PATH,'Datasets','datas'))
parser.add_argument('--dst_path', type=str, default=p.join(PATH, 'distribution'))
